...
<main class="container">
    ...
    <form class="container__formulario" method="post" enctype="multipart/form-data">
        ...
        <div class="formulario__campo">
            ...
            <input name="url" value="<?php echo $video?->url; ?>" class="campo__escrita" required placeholder="Por exemplo: https://www.youtube.com/embed/FAY1K2aUg5g" id='url' />
        </div>


        <div class="formulario__campo">
            <label class="campo__etiqueta" for="titulo">Titulo do vídeo</label>
            <input name="titulo" value="<?php echo $video?->title; ?>" class="campo__escrita" required placeholder="Neste campo, dê o nome do vídeo" id='titulo' />
        </div>
